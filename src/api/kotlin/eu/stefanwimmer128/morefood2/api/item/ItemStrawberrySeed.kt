...
open class ItemStrawberrySeed @JvmOverloads constructor(block: Block = MoreFood2API.instance!!.blocks["strawberry_bush"]!!, val name: String = "strawberry_seed", val resourceDomain: String? = null): ItemSeeds(block, null) {
    init {

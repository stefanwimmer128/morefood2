...
open class CommonProxy {
    ...
    open fun preInit(e: FMLPreInitializationEvent) {
        ...
        MoreFood2.instance.blocks.populate<BlockRegistry> {
            add(BlockStrawberryBush(resourceDomain, "strawberry_bush"))
        }
        MoreFood2.instance.items.populate<ItemRegistry> {
            ...
            add(ItemStrawberrySeed(MoreFood2.instance.blocks["strawberry_bush"]!!, "strawberry_seed", resourceDomain))
        ...
        MoreFood2.instance.itemFoods.populate<ItemFoodRegistry> {
            ...
            add(ItemMilkBottle(2, name = "milk_bottle", resourceDomain = resourceDomain))
            ...
            add(ItemStrawberry(2, name = "strawberry", resourceDomain = resourceDomain))
        }
    }
    
    open fun init(e: FMLInitializationEvent) {
        @Throws(NullPointerException::class)
        fun items(key: String): Item =
            when {
                MoreFood2.instance.blocks.containsKey(key) ->
                    Item.getItemFromBlock(MoreFood2.instance.blocks[key]!!)
                MoreFood2.instance.items.containsKey(key) ->
                    MoreFood2.instance.items[key]!!
                MoreFood2.instance.itemFoods.containsKey(key) ->
                    MoreFood2.instance.itemFoods[key]!!
                else ->
